...
from app.main import INSTAGRAM_PROFILE_INFO_URL, Settings, create_app
...
def test_hd_image_is_preferred_and_username_is_normalized(tmp_path: Path) -> None:
...
def make_client(
    ...
    return TestClient(create_app(settings, session)), session
